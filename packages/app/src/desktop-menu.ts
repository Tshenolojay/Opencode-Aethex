...
export const DESKTOP_MENU: DesktopMenu[] = [
  ...
  },
  {
    ...
    label: "Help",
    items: [
      { type: "item", label: "OpenCode Aethex Documentation", href: "https://opencode.ai/docs" },
      ...
      { type: "separator" },
      {
        ...
        href: "https://github.com/Tshenolojay/Opencode-Aethex/issues/new?template=feature_request.yml",
      },
      {
        type: "item",
        label: "Report a Bug",
        href: "https://github.com/Tshenolojay/Opencode-Aethex/issues/new?template=bug_report.yml",
      },
    ],
  },
]
